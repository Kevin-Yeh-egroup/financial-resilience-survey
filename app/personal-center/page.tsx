...
const TOOLS: Record<string, CenterTool> = {
  accounting: {
    ...
    description:
      "很多人不是不會賺錢，是不知道錢不見在哪裡。用手機就能記一筆、分類一下，久了就會發現：原來這裡省一點、那裡調一下，心裡就比較踏實。不用自己當會計師，也能慢慢把家裡的現金流弄清楚。",
    benefits: [
      "不用再靠感覺猜「錢到底花去哪」——圖表拉出來，一看就懂。",
      "AI 會幫你留意花費習慣，哪裡特別固定、哪裡特別衝動，心裡比較有譜。",
      "有記帳習慣之後，要談預算、要規劃下一步，比較有根據，也比較敢跟家人一起聊。",
    ],
  ...
  resilience: {
    ...
    benefits: [
      ...
      "把「我覺得還行」跟「分數怎麼說」放在一起看，比較不會誤判自己的狀況。",
    ],
  ...
  fraud: {
    ...
    description:
      "現在的詐騙常常長得像通知、像熟人借錢、像限時優惠。這份檢測不叫你死背口訣，而是讓你發現：壓力一來，你習慣先相信、先轉帳，還是先緩一緩、先查證？先認識自己的習慣，才知道哪裡要練習踩煞車。",
    benefits: [
      "知道自己「容易心軟」還是「容易急」，下次接到可疑訊息，心裡會多一個提醒。",
      "結果會對應到幾種常見反應類型，不是貼標籤，而是幫你找到適合你的防範節奏。",
      "可以跟家人一起做、一起對答案，彼此提醒，比一個人硬扛有效。",
    ],
  ...
  anxiety: {
    ...
    description:
      "題目不難，就是問你：帳單快來、薪水還沒進帳的時候，你通常怎麼想、怎麼反應。做完會得到一個大概的輪廓，讓你知道「原來很多人也會這樣」，也比較敢去找人聊、或試試看調整一小步。",
    benefits: [
  ...
  dream: {
    ...
    description:
      "很多人心裡有目標，但不知道從哪裡下手，就一直拖。這裡用引導式步驟，陪你想想：錢從哪來、什麼要先擋、什麼可以緩一緩。一步一步排下去，比較不會三分鐘熱度，也比較敢跟家人說你在拼什麼。",
    benefits: [
      "大願望不會只停在「好想喔」，而是變成排得出來的順序。",
      "比較清楚每個月可以挪多少給這個目標，心裡有底，比較不會亂花又後悔。",
      "若你已經在記帳、做評估，可以把數字跟夢想接在一起，計畫比較站得住腳。",
    ],
