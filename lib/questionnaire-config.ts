...
export const structureTypeConfig = {
  ...
  E: {
    ...
    description: "家庭表面上具備某些可用資源，例如收入、帳戶、保險、制度或支持對象，\n但因金錢管理能力不足、對財務問題缺乏信心，\n這些資源無法被實際動用或轉換為有效承接力。\n\n此類型的風險不在於資源缺乏，\n而在於「結構卡在啟動前一刻」，導致遇到壓力時仍只能被動承受。",
  },
  F: {
    name: "一直被拖回原點的",
    subtitle: "循環消耗型",
    description: "家庭長期處於債務、壓力與管理困難交織的狀態，\n即使曾短暫改善或有人協助，\n仍容易因壓力反覆累積而回到原本的高風險結構。\n\n此類型的特徵不是單一弱項，\n而是多個弱點形成自我消耗的結構循環，使任何調整都難以持續。",
  },
} as const
